...
import com.example.notecrud.databinding.ActivityNoteAddUpdateBinding
import com.example.notecrud.helper.DateHelper
...
class NoteAddUpdateActivity : AppCompatActivity() {
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        // Only show the menu if it is in edit mode
        if (isEdit) {
